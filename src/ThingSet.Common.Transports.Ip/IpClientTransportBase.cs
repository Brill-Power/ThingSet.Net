...
public abstract class IpClientTransportBase : ClientTransportBase<IPEndPoint>, IClientTransport
{
    ...
    protected IpClientTransportBase(string hostname) : this(hostname, Protocol.RequestResponsePort)
    {
    }

    protected IpClientTransportBase(string hostname, int port)
    {
        _hostname = hostname;
        _port = port;
