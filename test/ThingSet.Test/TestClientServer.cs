...
public class TestClientServer
{
    ...
    public async Task TestBasic()
    {
        ...
        IpClientTransport clientTransport = new IpClientTransport("127.0.0.1");
        IpServerTransport serverTransport = new IpServerTransport(IPAddress.Loopback);
        ThingSetServer server = new ThingSetServer(serverTransport);
        ThingSetClient client = new ThingSetClient(clientTransport);
